...
import com.example.testbarang.AdapterLihatBarang;
import com.example.testbarang.LihatBarang;



public class ReadActivity extends AppCompatActivity implements AdapterLihatBarang.FirebaseDataListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        database.child("barang").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                 ...
                 */
                adapter = new AdapterLihatBarang(daftarBarang, ReadActivity.this);
